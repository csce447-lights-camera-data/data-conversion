...
keep = ['original_title', 'avg_vote', 'votes', 'budget', 'worlwide_gross_income', 'genre', 'director', 'writer', 'actors', 'description', 'production_company'] # Minified to reduce filesize
ints = ['votes']
floats = ['avg_vote']
